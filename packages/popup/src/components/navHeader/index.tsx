  ...
  render() {
    ...
    return (
      <div className="nav-main">
        ...
        <span className="nav-page-name">{PAGE_NANE_DIC[appState]}</span>
        ...
        {this.showModal && (
          <div className="nav-modal" onClick={this.stopPropagation}>
            <div className="nav-addAccount-box">
              <span className="nav-myAccount">My Accounts</span>
            ...
            <div className="nav-setting-box" onClick={this.turnToSetting}>
              ...
              <span className="nav-setting-word">setting</span>
            </div>
          </div>
        )}
      </div>
